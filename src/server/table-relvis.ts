...
export const relvis = (context: Context): TableDefinition => {
  ...
  const puedeEditarToken = context.user.usu_rol === 'programador' || context.user.usu_rol === 'coordinador' || context.user.usu_rol === 'analista' || context.user.usu_rol === 'recepcionista' || context.user.usu_rol === 'jefe_recepcion' || context.user.usu_rol === 'jefe_campo';
  return {
    name: 'relvis',
    title: 'Relvis',
    ...
    fields: [
      ...
      { name: 'visita', typeName: 'integer', nullable: false, defaultValue: 1, allow: { update: false }, title: 'vis' },
      ...
      { name: 'ultimavisita', typeName: 'integer', nullable: false, defaultValue: 1, allow: { update: false }, visible: false },
