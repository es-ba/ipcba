        ...
        sql:{
            ...
            from: `(select rv.periodo, panel, tarea, rp.fechasalida, rv.informante, rv.visita, i.nombreinformante, i.direccion, i.contacto, i.telcontacto, i.web, i.email, rub.nombrerubro, 
                    ...
                    from (select * from personal per where per.username = ${db.quoteLiteral(context.user.usu_usu)}) per
                        ...
                        and current_timestamp between COALESCE(ri.fechasalidadesde,rp.fechasalidadesde, rp.fechasalida)+interval '9 hours'  and COALESCE(ri.fechasalidahasta,rp.fechasalidahasta, rp.fechasalida)
