        ...
        var menuPrincipal = [
            ...
            {menuType:'menu', name:'gabinete', menuContent:[
                ...
                {menuType:'menu', name:'controles', menuContent:[
                    ...
                    {menuType:'table', name:'periodos_control_diccionario_atributos_val', label:'inconsistencias de diccionario de atributos (valor)', onlyVisibleFor:[programador,coordinador,analista]},
