    ...
    */
    ...
    getMenu(context){
        ...
        if(this.config.server.policy=='canastas'){
            ...
            return {menu:[
                {menuType:'menu', name:'resultados', menuContent:[
                    { menuType: 'table', name: 'periodos_calgruper', onlyVisibleFor:asignadores },
                    { menuType: 'table', name: 'periodos_calprodperagr', onlyVisibleFor:asignadores },
        ...
        var subMenuCalculos = [
            ...
            {menuType:'calculo_borrar_copia', name:'borrar copias', label:'borrar copias', onlyVisibleFor:[programador, coordinador, analista]},
        ]
        ...
        var menuPrincipal = [
            ...
            {menuType:'menu', name:'gabinete', menuContent:[
                ...
                {menuType:'menu', name:'controles', menuContent:[
                    ...
                    {menuType:'proc' , name:'control_cambios_exportar'                , label:'cambios de atributos exp', onlyVisibleFor:[programador,coordinador,analista,recepcionista,jefeRecepcion]},
            ...
            {menuType:'menu', name:'analisis', label:'análisis', menuContent:[
                ...
                {menuType:'menu', name:'listados', label:'listados', onlyVisibleFor:[programador,coordinador,analista], menuContent:[
                    ...
                    {menuType:'menu', name:'precios'  , label:'precios'  , onlyVisibleFor:[programador,coordinador,analista], menuContent:[
                        ...
                        {menuType:'proc' , name:'control_sinvariacion_exportar'                   , label:'precios sin variacion exp'},
