...
*`
        ...
        var menuPrincipal = [
            ...
            {menuType:'menu', name:'gabinete', menuContent:[
                ...
                {menuType:'menu', name:'controles', menuContent:[
                    ...
                    {menuType:'table', name:'periodos_control_diccionario_atributos'  , label:'inconsistencia de diccionario', onlyVisibleFor:[programador,coordinador,recepcionista,analista]},
                    {menuType:'table', name:'periodos_control_diccionario_atributos_val', label:'inconsistencia de diccionario (corrección)', onlyVisibleFor:[programador,coordinador,analista]},
    ...
    getTables(){
        return super.getTables().concat([
            ...
            {name: 'periodos_control_diccionario_atributos', path: __dirname},
