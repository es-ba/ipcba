        ...
        var menuPrincipal = [
            ...
            {menuType:'menu', name:'gabinete', menuContent:[
                ...
                {menuType:'menu', name:'controles', menuContent:[
                    {menuType:'table', name:'periodos_relpre_control_rangos_recepcion', label:'inconsistencias de precios Rec', onlyVisibleFor:[programador,recepcionista,supervisor,jefeCampo]},
