...
export const informantes = (context:Context):TableDefinition => {
    ...
    return {
        ...
        fields:[
            ...
            {name:'ordenhdr'             , typeName:'integer'    , allow:{update:puedeEditar||puedeEditarMigracion} , nullable:false                , defaultValue:100          },
            ...
            {name:'muestra'              , typeName:'integer'    , allow:{update:puedeEditar||puedeEditarMigracion} , nullable:false                , defaultValue:1            },
