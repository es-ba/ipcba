        ...
        sql:{
            from:`
                (select v.periodo, v.informante, v.visita, 
                      ...
                      group by v.periodo, v.informante, i.nombreinformante, i.direccion, ri.observaciones,v.visita, v.panel, v.tarea, max_periodos.maxperiodoinformado, contacto, telcontacto, web, email
                  )
            `
        }        
    },context);
