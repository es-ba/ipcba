...
export const reltar = (context: Context):TableDefinition => {
    const puedeEditar = context.user.usu_rol ==='programador' || context.user.usu_rol ==='analista' || context.user.usu_rol ==='coordinador' || context.user.usu_rol ==='jefe_campo'|| context.user.usu_rol ==='supervisor'|| context.user.usu_rol ==='recepcionista' || context.user.usu_rol ==='jefe_recepcion';
    const puedeEditarMigracion = context.user.usu_rol ==='programador' || context.user.usu_rol ==='migracion';
    const puedeEditarAnalisis = context.user.usu_rol ==='programador' || context.user.usu_rol ==='analista' || context.user.usu_rol ==='coordinador';
    const puedeEditarProgramador = context.user.usu_rol ==='programador';
    return {
        name:'reltar',
        ...
        fields:[
            ...
            {name:'id_instalacion'             , typeName:'integer'                              , allow:{update:puedeEditarProgramador}},
