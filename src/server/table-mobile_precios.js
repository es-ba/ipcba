                ...
                lateral((
                  ...
                  lateral(
                    ...
                    where moverperiodos(r.periodo,-1) >= rp_2_3.periodo and moverperiodos(r.periodo,-4) <= rp_2_3.periodo and r.producto = rp_2_3.producto and r.observacion = rp_2_3.observacion and r.informante = rp_2_3.informante and r.visita = rp_2_3.visita and rp_2_3.tipoprecio in ('S',null)
                        ...
                        group by r.periodo, r.producto, r.observacion, r.informante, r.visita, rv.panel, rv.tarea, r.precio, r.tipoprecio, r.cambio, c.antiguedadexcluido, r_1.precio, r_1.tipoprecio, r_1.comentariosrelpre, r_1.esvisiblecomentarioendm, c_1.antiguedadsinprecio, c_1.promobs,
