...
export const relatr = (context:Context):TableDefinition => {
    ...
    return {
        ...
        fields:[
            ...
            {name:'visita'                           , typeName:'integer' , nullable:false , defaultValue:1, allow:{update:false}, inTable:true},
        ...
        detailTables:[
            {table:'relatr_tipico', label:'Valores Típicos', fields:['periodo','producto','atributo'], abr:'V'}
        ],
