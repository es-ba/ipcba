...
ALTER TABLE cvp.informantes ADD constraint informantes_calle_fkey FOREIGN KEY (calle)
        REFERENCES cvp.calles (calle) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION;
ALTER TABLE informantes ADD constraint informantes_provincia_fkey FOREIGN KEY (provincia)
        REFERENCES cvp.provincias (provincia) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION;
