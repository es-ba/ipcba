set search_path = cvp;
GRANT INSERT ON TABLE pantar TO cvp_administrador;

UPDATE parametros SET permitir_cualquier_cambio_panel_tarea = true where unicoregistro;
...
BEGIN
  ...
  */
  ...
  --26/06/2020: tareas nuevas (agregadas a pantar)
  INSERT INTO cvp.relTar(periodo, panel, tarea, encuestador)
