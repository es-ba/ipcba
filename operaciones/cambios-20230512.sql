...
DROP TRIGGER relvis_actualiza_estado_informante_trg ON relvis;
DROP FUNCTION actualizar_estado_informante_trg();
DROP VIEW estadoinformantes;
DROP VIEW IF EXISTS paralistadodecontroldecm;
DROP FUNCTION estadoinformante(text, integer);
...
----------------------------TABLE INFORMANTES------------------------------
ALTER TABLE informantes drop COLUMN estado;
