CREATE OR REPLACE VIEW variaciones_maximas_vw AS
SELECT a.periodo, a.producto, a.nombreproducto, 
  ...
  FROM (SELECT * FROM
        ...
        LEFT JOIN cvp.periodo_maximas_variaciones(10) m ON a.periodo = m.periodo and a.producto = m.producto and a.nombreproducto = m.nombreproducto 
  ORDER BY a.periodo, a.producto, a.nombreproducto;

GRANT SELECT ON TABLE variaciones_maximas_vw TO cvp_administrador;
