CREATE OR REPLACE VIEW precios_minimos_vw AS
SELECT a.periodo, a.producto, a.nombreproducto, 
      ...
      FROM (SELECT * FROM
        ...
        LEFT JOIN cvp.periodo_minimos_precios(10) m ON a.periodo = m.periodo and a.producto = m.producto and a.nombreproducto = m.nombreproducto 
    ORDER BY a.periodo, a.producto, a.nombreproducto;

GRANT SELECT ON TABLE precios_minimos_vw TO cvp_administrador;
