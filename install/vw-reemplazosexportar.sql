CREATE OR REPLACE VIEW reemplazosexportar AS 
 SELECT 
   ...
   ii.ordenhdr,
   ii.distrito,
   ii.fraccion_ant, ii.comuna, ii.fraccion, ii.radio, ii.manzana, ii.depto, ii.barrio,
   ii.rubro,
   r.nombrerubro
   FROM cvp.relvis v
     ...
     GROUP BY v.periodo, v.panel, v.tarea, v.fechasalida, ii.conjuntomuestral, v.encuestador, 
       ...
       ii.nombreinformante, ii.direccion,  ii.ordenhdr, ii.distrito, ii.fraccion_ant, ii.comuna, ii.fraccion, ii.radio, ii.manzana, ii.depto, ii.barrio, ii.rubro, r.nombrerubro 
