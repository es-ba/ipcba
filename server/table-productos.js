...
module.exports = function(context){
    ...
    return context.be.tableDefAdapt({
        ...
        fields:[
            ...
            {name:'formula'                     , typeName:'text' , nullable:false, default:'General',defaultValue:'General', allow:{select:false}},
            {name:'estacional'                  , typeName:'text' , nullable:false, default:'N',defaultValue:'N'      , allow:{select:false}},
            ...
            {name:'tipocalculo'                 , typeName:'text' , nullable:false, default:'D', defaultValue:'D'      , allow:{select:false}},
            ...
            {name:'codigo_ccba'                 , typeName:'text'                                    , allow:{select:false}},
            ...
            {name:'nombreparaformulario'        , typeName:'text'                                    , allow:{select:false}},
        ],
        primaryKey:['producto'],
        foreignKeys:[
