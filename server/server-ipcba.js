    ...
    getMenu(context){
        ...
        return {menu:[
            ...
            {menuType:'menu', name:'gabinete', menuContent:[
                ...
                {menuType:'table', name:'periodos_relpre_control_rangos' , label:'control de inconsistencias de precios',onlyVisibleFor:[programador,analista,coordinador,jefeCampo,recepcionista,supervisor] },
                //{menuType:'table', name:'periodos_relpre_control_rangos_recepcion' , label:'control de inconsistencias de precios recepción', onlyVisibleFor:[programador,coordinador,analista,recepcionista,supervisor]},
