...
module.exports = function(context){
    ...
    return context.be.tableDefAdapt({
        ...
        fields:[
            ...
            {name:'repregunta'                   , typeName:'text'                                 , allow:{update:false}, title:'R'        },            
            {name:'excluido'                     , typeName:'text'                                 , allow:{update:false}, title:'X'        },            
            {name:'antiguedadsinprecioant'       , typeName:'integer'                              , allow:{update:false}, title:'Aspa'     },            
            {name:'precioanterior'               , typeName:'decimal'                              , allow:{update:false}                   },
            {name:'tipoprecioanterior'           , typeName:'text'                                 , allow:{update:false}, title:'TPa'      },
